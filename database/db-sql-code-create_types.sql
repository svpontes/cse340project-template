-- Type: account_type - cse340
-- DROP TYPE IF EXISTS public.account_type;
CREATE TYPE public.account_type AS ENUM ('Client', 'Employee', 'Admin');
ALTER TYPE public.account_type OWNER TO cse340dbuser;
...
--create inv_miles to inventory table
ALTER TABLE inventory
ADD COLUMN inv_miles integer NOT NULL;
...
--Data for populate the table `classification`
